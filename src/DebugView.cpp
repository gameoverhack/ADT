...
DebugView::DebugView(){
    ...
    newDebugViewStates.addState(State(kDEBUGVIEW_SHOWGUI, "kDEBUGVIEW_SHOWGUI"));
    ...
    debugViewStates.setState(kDEBUGVIEW_SHOWINFO, false);
    debugViewStates.setState(kDEBUGVIEW_SHOWGUI, true);
...
void DebugView::update(){
    ...
    begin();
    {
        ...
        if(debugViewStates.getState(kDEBUGVIEW_SHOWGUI)) appModel->getGui()->draw();
        ofDisableBlendMode();
    }
    end();
